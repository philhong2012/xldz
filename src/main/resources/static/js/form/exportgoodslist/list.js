...
$(function() {
    layui.use('table', function(){
        ...
        tableIns=table.render({
            elem: '#exportGoodsList'
            ,url:'/exportgoodslist/list'
        ...
        //监听提交
        form.on('submit(exportGoodsListSubmit)', function(data){
            // TODO 校验
            formSubmit(data);
            return false;
        });
...
function exportFile() {
    var table = layui.table;
    var checkStatus = table.checkStatus('exportGoodsList');
    if(checkStatus.data.length > 0) {
        window.location.href = '/exportgoodslist/download?id='+checkStatus.data[0].id;
